...
AI 服務應用需要高速的地端與雲、網連結資源，滿足企業對AI 服務應用的各種場域需求>。
 ...
 - 目前市場上對於如 GB200、GB300 等高階AI伺服器的水冷環境需求日益升高，但供給明顯不足。是方聯雲智能資料中心（LY2）在水冷、高電力、高承載三大技術面布局已久，能提供最快速、最穩定的AI基礎設施，尤其是新推出的「國際級中立水冷AI資料中心拎包入住服務方案」，更是企業切入AI服務和應用的最佳選擇。企業只需自備AI伺服器，即可即時進駐，省去建置機房的繁瑣流程，並透過TPIX快速連接全球。
